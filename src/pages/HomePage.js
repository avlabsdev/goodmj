        ...
        <section className="flex lg:flex-row justify-between flex-col">
          <div className="2xl:w-1/2 border-white border-2 rounded-lg md:w-full">
            <img
              ...
              className="lg:rounded-tl-lg lg:rounded-bl-lg flex-grow object-cover h-full lg:rounded-tr-none rounded-tr-lg rounded-bl-none rounded-tl-lg"
            />
          </div>
          <div className="2xl:text-left xl:text-left lg:text-left md:p-20 2xl:w-1/2 md:w-full flex flex-col gap-4 justify-center relative sm:text-center p-5">
            <img
              ...
              className="2xl:absolute xl:absolute lg:absolute 2xl:w-1/4 2xl:top-8 2xl:right-20 xl:w-1/5 xl:top-4 xl:right-20 lg:top-8 lg:w-1/5 lg:right-20 md:w-1/3 md:relative md:top-0 mx-auto sm:w-1/3 xs:w-1/5 w-1/3 relative sm:relative sm:top-0 top-0 right-0"
            />
            <h1 className="custom-text-green 2xl:text-7xl lg:text-left font-bold xl:text-6xl lg:text-4xl md:text-6xl sm:text-6xl text-4xl sm:text-center text-center md:text-center">
