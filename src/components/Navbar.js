...
import { faUser, faFileSignature, faBars } from '@awesome.me/kit-bc1b6271da/icons/classic/solid'
import logo from '../logo.svg';

const Navbar = () => {
  return (
    <div className="container mx-auto flex flex-col gap-8 mt-4 mb-4 px-4">
      <header className="bg-white flex justify-between items-center py-4 px-6 rounded-lg shadow">
        <div className="flex items-center gap-4">
          ...
          <div className="lg:flex pl-6 border-l-2 text-sm items-center gap-2 hidden">
        ...
        <a href="#/" className="lg:hidden p-2 text-xl"><FontAwesomeIcon icon={faBars} /></a>
