      ...
      <main className="bg-white rounded-lg shadow">
        <section className="flex lg:flex-row justify-between flex-col">
          ...
          <div className="2xl:text-left xl:text-left lg:text-left md:p-20 2xl:w-1/2 md:w-full flex flex-col gap-4 justify-center relative sm:text-center p-10">
            ...
            <h1 className="custom-text-green 2xl:text-7xl font-bold xl:text-6xl lg:text-5xl md:text-6xl sm:text-6xl">Affordable cannabis for all</h1>
            <h2 className="font-semibold 2xl:text-2xl xl:text-xl custom-text-darkblue lg:text-lg md:text-lg sm:text-md">The only place here to help you get all your cannabis products and prescriptions at prices you can afford and sustain.</h2>
