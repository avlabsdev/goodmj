        ...
        <section className="flex justify-between align-center">
          ...
          <div className="p-10 w-1/2 flex flex-col gap-4 justify-center">
            ...
            <div className="flex gap-2 mt-4">
              <a href="#/" className="py-4 px-24 bg-blue-300 text-center rounded-md custom-bg-green text-white font-medium">Button</a>
              <a href="#/" className="py-4 px-24 bg-blue-300 text-center rounded-md custom-bg-darkblue text-white font-medium">Button</a>
            </div>
          </div>
        </section>
      </main>
