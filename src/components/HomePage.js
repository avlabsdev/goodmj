      ...
      <main className="bg-white rounded-lg shadow">
        <section className="flex justify-between items-center">
          ...
          <div className="p-20 w-1/2 flex flex-col gap-4 justify-center items-center relative">
            ...
            <h2 className="font-semibold 2xl:text-2xl xl:text-xl">The only place here to help you get all your cannabis products and prescriptions at prices you can afford and sustain.</h2>
