    ...
    <div className="container mx-auto py-4 flex gap-8 px-4">
      <main className="flex flex-col gap-8 w-4/6">
        ...
        <section className="bg-white rounded-lg p-8">
          ...
          <div className="flex gap-8 mt-8">
            <a href="#/" className="h-full rounded-lg w-1/4 aspect-square border-2 border-white shadow relative flex hover:-mt-1 ease-in-out duration-200">
      ...
      <aside className="w-2/6 bg-white rounded-lg h-min sticky top-8">
        ...
        <div className="p-10 flex flex-col gap-4 custom-bg-lightblue border-l-2 border-r-2 border-white relative">
          <p className="flex gap-4 z-10"><span className="font-medium custom-text-darkblue">Address:</span> 12121 Madison Ave, Clifton, OH 44107</p>
          <p className="flex gap-4 z-10"><span className="font-medium custom-text-darkblue">Hours:</span>7:00 AM - 9:00 PM</p>
          <p className="flex gap-4 z-10"><span className="font-medium custom-text-darkblue">Phone:</span>(123) 456-7890</p>
          <p className="flex gap-4 z-10"><span className="font-medium custom-text-darkblue">Shop:</span><a href="#/" className="underline hover:no-underline">ordercannabis.com</a></p>
          <img src={mapImage} alt="Map" className="absolute w-1/2 -right-8 -bottom-8 overflow-hidden z-0" />
        </div>
